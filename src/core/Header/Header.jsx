      ...
      <nav className=" mx-auto  px-4 flex items-center 2xl:gap-80 xl:gap-40 ">
        ...
        >
          <div className="flex flex-col gap-5 mt-10 six lg:flex-row  lg:my-0 my-10 md:my-10 text-center  md:items-center md:justify-end   ">
            <Link
              className={`lg:font-medium font-bold focus:text-green-950 lg:active:text-green-950   lg:text-gray-400 text-black  hover:text-green-950    focus:outline-none ${isActive('/') ? ' text-green-950 ' : ' text-black  '}`}
              to="/"
              aria-current="page"
              onClick={ handleClick}
            >
            ...
            <Link
              className={`lg:font-medium font-bold focus:text-green-950   active:text-green-950 lg:text-gray-400 text-black hover:text-green-950   focus:outline-none  ${isActive('/about') ? 'text-blue-700' : ''}`}
              to="/about"
              onClick={ handleClick}
            >
             About Us
            ...
            <Link
              className="lg:font-medium font-bold focus:text-green-950 active:text-green-950 lg:text-gray-400 text-black hover:text-green-950   focus:outline-none "
              to="/services"
              onClick={ handleClick}
            >
              Services
