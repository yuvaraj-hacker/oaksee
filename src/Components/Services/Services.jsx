    ...
    return (
        <>
            <HelmetProvider>
                ...
                <section className="2xl:max-w-[74rem] xl:max-w-[65rem] lg:max-w-[64rem]  heights 2xl:mt-36 xl:mt-32 mt-36  mx-auto 2xl:px-5 xl:px-14 lg:px-16 px-5 mb-7">
                        ...
                        <div className="">
                            ...
                            <div className='space-y-4'>
                                <div className="     hover:border hover:shadow-md bg-white border hover:shadow-yellow-100  z-40 lg:p-2   hover:scale-105 transition-transform duration-300 ease-in-out   mx-auto    lg:grid  lg:grid-cols-4        ">
                                    ...
                                    <div className="text-justify z-40  col-span-3  2xl:text-base lg:text-sm px-5 2xl:mt-0 xl:mt-2 lg:py-0 py-3 ">
                                ...
                                <div className="   lg:grid  lg:grid-cols-4    hover:border hover:shadow-md bg-white border hover:shadow-yellow-100  z-40 lg:p-2   hover:scale-105 transition-transform duration-300 ease-in-out      mx-auto   ">
                                    ...
                                    <div className="text-justify z-40  2xl:text-base lg:text-sm col-span-3 px-5 lg:py-0  2xl:mt-0 xl:mt-5 py-3">
                                        <div className="flex gap-2">
                                            <img className="w-2 h-2 mt-2" src='/Images/green.png' alt='fullstop' />
                                ...
                                <div className="  lg:grid  lg:grid-cols-4    hover:border hover:shadow-md bg-white border hover:shadow-yellow-100  z-40 lg:p-2    hover:scale-105 transition-transform duration-300 ease-in-out     mx-auto   ">
                                    ...
                                    <div className="text-justify z-40  2xl:text-base lg:text-sm col-span-3 px-5 lg:py-0 py-3 2xl:mt-0 xl:mt-4">
                                        <div className="flex gap-2">
                                            <img className="w-2 h-2 mt-2" src='/Images/green.png' alt='fullstop' />
                                ...
                                <div className="  lg:grid  lg:grid-cols-4    hover:border hover:shadow-md bg-white border hover:shadow-yellow-100  z-40 lg:p-2  hover:scale-105 transition-transform duration-300 ease-in-out       mx-auto   ">
                                    ...
                                    <div className="text-justify z-40  2xl:text-base lg:text-sm col-span-3 px-5 lg:py-0 py-3 2xl:mt-0 xl:mt-5">
                                        <div className="flex gap-2">
                                            <img className="w-2 h-2 mt-2" src='/Images/green.png' alt='fullstop' />
                                ...
                                <div className="  lg:grid  lg:grid-cols-4     hover:border hover:shadow-md bg-white border hover:shadow-yellow-100  z-40 lg:p-2  hover:scale-105 transition-transform duration-300 ease-in-out       mx-auto   ">
                                    ...
                                    <div className="text-justify z-40  2xl:text-base lg:text-sm col-span-3 px-5 lg:py-0 py-3 2xl:mt-0 xl:mt-2">
                                        <div className="flex gap-2">
                                            <img className="w-2 h-2 mt-2" src='/Images/green.png' alt='fullstop' />
