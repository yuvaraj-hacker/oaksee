    ...
    return (
        <>
            <HelmetProvider>
                        ...
                        <div className="">
                            ...
                            <div className='space-y-4'>
                                <div className="     hover:border hover:shadow-md bg-white border hover:shadow-yellow-100  z-40 p-2       mx-auto    lg:grid  lg:grid-cols-4        ">
                                    <div className=" z-40     border-0  bg-green-950  text-xl  items-center  lg:py-0 py-5 flex justify-center text-yellow-500">
                ...
                <section className="  max-w-[100rem] mx-auto px-5 lg:text-lg text-sm mt-14  my-4" >
