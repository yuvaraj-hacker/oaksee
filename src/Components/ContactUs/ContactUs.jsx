   ...
   return (
      <>
         <HelmetProvider>
            ...
            <div className="2xl:max-w-[73rem] xl:max-w-[65rem] lg:max-w-[66rem] 2xl:mb-0 xl:mb-10  mx-auto   heights 2xl:mt-36 xl:mt-32 mt-36  2xl:px-5 xl:px-14 lg:px-16 px-5    ">
