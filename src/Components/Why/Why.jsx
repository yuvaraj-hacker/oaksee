  ...
  return (
    <>
      ...
      <div className="flex choose flex-col lg:gap-3  z-30">
        ...
        <div   className="  sm:[150px] z-40  border experience  lg:w-[1200px]  flex flex-wrap      flex-1  lg:gap-20 lg:p-4 md:p-2 rounded-md bg-green-950  text-white  hover:shadow-lg hover:shadow-yellow-100 ">
        ...
        <div  className="  rounded-md    lg:w-[1200px]   experience  z-40  h-fit border   flex flex-wrap    flex-1  lg:gap-20 lg:p-4 md:p-2  bg-green-950  text-white hover:shadow-lg hover:shadow-yellow-100    ">
        ...
        <div     className="  rounded-md  lg:w-[1200px]  sm:[150px] experience  z-40  h-[2-] border  flex flex-wrap    flex-1  lg:gap-20 lg:p-4 md:p-2  bg-green-950  text-white      hover:shadow-lg  hover:shadow-yellow-100    ">
          <div className="lg:w-[270px] md:[200px] h-fit z-50   border-0   text-xl text-yellow-500">
            Proven Track Record
          </div>
          <div className="text-justify z-40">
        ...
        <div     className=" rounded-md   lg:w-[1200px] sm:[150px] experience  z-40  h-1/2 border  flex flex-wrap  hover   flex-1  lg:gap-20 lg:p-4 md:p-2  bg-green-950  text-white     hover:shadow-lg hover:shadow-yellow-100  ">
          <div className="lg:w-[270px] md:[200px] h-fit z-50   border-0   text-xl text-yellow-500">
